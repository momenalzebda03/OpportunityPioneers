<template>
  <ComponentNavbarSignUp
    v-if="currentRoute != '/userProfile' || currentRoute !== '/pageCreateDataUser' || currentRoute !== '/companyProfile' || currentRoute !== '/pageCreateDataCompany'" />
  <ComponentNavbarUserProfile
    v-if="currentRoute == '/userProfile' || currentRoute == '/pageCreateDataUser' || currentRoute == '/companyProfile' || currentRoute == '/pageCreateDataCompany'" />
  <NuxtPage />
</template>
